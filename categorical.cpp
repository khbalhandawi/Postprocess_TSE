	...
	_s4(NULL)
{
	...
	bbit_2[1] = NOMAD::INTEGER;
	bbit_2[2] = bbit_2[3] = NOMAD::INTEGER;
	...
	// -----------------------
	{
		...
		bbit_3[1] = NOMAD::INTEGER;
		bbit_3[2] = bbit_3[3] = bbit_3[4] = NOMAD::INTEGER;
	...
	// -----------------------
	{
		...
		bbit_4[1] = NOMAD::INTEGER;
		bbit_4[2] = bbit_4[3] = bbit_4[4] = bbit_4[5] = NOMAD::INTEGER;
